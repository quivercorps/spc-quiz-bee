<template>
    <div>
        <div class="fixed w-full bottom-0 pb-6 pt-3 bg-[#121212]">
            <div class="flex justify-center gap-3">
                <UButton @click="deleteLobby" v-if="isHost" size="xl" :disabled="lobby?.players.length == 0">Start Game</UButton>
        ...
        <div class="py-5 px-3 lg:px-0 lg:w-1/2 lg:mx-auto">
            <UCard class="lg:mx-auto lg:w-[350px] mb-3">
                ...
                <template #footer>
                    <p class="text-center text-gray-400">Invite Code</p>
                    <p class="text-xl tracking-widest text-center">{{ lobby?.code }}</p>
                </template>
            </UCard>
